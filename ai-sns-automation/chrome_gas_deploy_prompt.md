...
【2. 最新コードを取得】
- 別タブで下記URL（私のドライブに置いた最新版Code.gs全文）を開く:
  https://drive.google.com/file/d/11_Pj94ojje1xH9VGMD2WxmMt74hsFnbB/view
- ファイル名は「【GAS更新用】Code.gs_最新版」
- 中身を全選択してコピー
  （ブラウザでプレビューできない場合はダウンロードして開く）
...
- 貼り付け後、コードの末尾に function json_(obj) があること、
  および listFolder_ / getFileBase64_ / uploadFile_ の3関数があることを確認
