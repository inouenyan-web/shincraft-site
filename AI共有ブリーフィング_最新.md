...
### 📩 2026-06-28 20:06 Instagram DM 手動チェック（自動リマインド）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-06-28 20:06 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 3件 / うち受注関連の可能性 3件

**🧾 受注関連の可能性（要対応・チェックでクローズ）:**
- [ ] "ラクスル" <mag@raksul.com> ｜ ラクスル会員様限定◆のぼり印刷やその他複数商品が今なら50%OFF！
- [ ] "〔ラクスル〕" <order@raksul.com> ｜ 名刺印刷の受付日が06月27日で確定しました - ご注文番号 260627760130-01〔ラクスル〕
- [ ] "〔ラクスル〕" <order@raksul.com> ｜ ご注文内容およびクレジット決済完了のご案内 - ご注文番号 260627760130〔ラクスル〕
<!-- GMAIL_INBOX:END -->

<!-- CHATWORK_INBOX:START -->
### 💬 2026-06-28 20:06 Chatwork 新着チェック（既読ルームのみ自動）
