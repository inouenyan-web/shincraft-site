...
### 📨 2026-07-01 02:08 Instagram DM チェック（Meta Business Suite）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-07-01 02:08 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 8件 / うち受注関連の可能性 1件
...
### 💬 2026-07-01 02:08 Chatwork 新着チェック（既読ルーム精査）
...
<!-- IG_DM_INBOX:START -->
### 📩 2026-07-01 02:08 Instagram DM 新着チェック（会話精査）
...
<!-- IG_DM_MANUAL:START -->
### 📩 2026-07-01 00:12 JST Instagram DM 受注・要対応（Cowork目視 / Meta Business Suiteより）

- [ ] 🔴 [DM] y.s：iQOSイルマワン両面加工（本体カラー黒）8500円(送料込)。**PayPay送金完了**（送金者名「ぐろりあ」・火21:56頃）→ 入金確認＋お礼＋制作開始の返信が必要【前回「明日チャージして支払い」から入金済みに進展】
...
（お礼のみ/いいね/ストーリーズメンション/雑談はタスク化対象外：Takaoki Moriguchi＝😍リアクション、Life Design Lab 朔矢＝お礼のみ）
※前回ログのディープさん（タイニープードル）・Boost Worksは今回の直近会話ウィンドウに非表示（旧ログ扱い／必要時に受信箱で要確認）。
<!-- IG_DM_MANUAL:END -->
