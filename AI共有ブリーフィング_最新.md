...
### 📨 2026-06-30 12:34 Instagram DM チェック（Meta Business Suite）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-06-30 12:34 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 4件 / うち受注関連の可能性 2件
...
### 💬 2026-06-30 12:34 Chatwork 新着チェック（既読ルーム精査）

既読ルーム 0件を走査 / 途中・要対応 0件 / 受注関連 0件
...
<!-- IG_DM_INBOX:START -->
### 📩 2026-06-30 12:34 Instagram DM 新着チェック（会話精査）
...
<!-- IG_DM_MANUAL:START -->
### 📩 2026-06-30 Instagram DM 受注・要対応（Cowork目視 / Meta Business Suiteより）

- [ ] 🔴 [DM] y.s：PayPay支払いの相談「いま残高ないので明日チャージして朝支払いでも大丈夫ですか？」→ 未返信・要返信（入金タイミング可否を回答）
- [ ] 🟡 [DM] やっちゃん：商品作成済み。「今回作成した商品をインスタに挙げてもよろしいでしょうか？」と当方から確認済み → 相手の掲載許可待ち（フォロー）
- [ ] 🟡 [DM] ディープさん（タイニープードル）：添付ファイルを受領 → 内容確認（受注素材の可能性）
