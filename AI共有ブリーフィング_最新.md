...
### 📨 2026-07-02 15:27 Instagram DM チェック（Meta Business Suite）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-07-02 15:27 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 5件 / うち受注関連の可能性 1件
...
### 💬 2026-07-02 15:27 Chatwork 新着チェック（既読ルーム精査）
...
<!-- IG_DM_INBOX:START -->
### 📩 2026-07-02 15:27 Instagram DM 新着チェック（会話精査）
...
<!-- IG_DM_MANUAL:START -->
### 📩 2026-07-02 12:42 JST Instagram DM 受注・要対応（Cowork目視 / Meta Business Suiteより）

- [ ] 🔴 [DM] y.s：iQOSイルマワン両面加工（本体カラー黒）8500円(送料込)。PayPay入金確認済（送金者「ぐろりあ」）＋当方「入金ありがとうございます！デザイン作成次第、追って連絡いたします」送信済 → **デザイン制作→完成連絡・納品が未完＝要フォロー（現状唯一の入金済み進行中受注）**。相手最新(9:34)「よろしくお願いいたします」
- [ ] 🟡 [DM] Dogs&Cats Special party：当方「shincraft イノウエシンイチロウ で入金いたしました。よろしくご査収ください」送信済（振込完了・取引）→ 先方の受領確認待ち（フォロー）

直近会話ウィンドウ8件を精査。今回クローズ／対象外：
- 高橋じゅん：名入れスタンド（漢字「千鶴」・大7660円）納品完了・当方お礼送信済 → クローズ
- やっちゃん：iQOS納品完了・掲載許可取得済・当方お礼送信済 → クローズ
- ディープさん(Deep Impact)／Boost Works／RinTon：当方の販促画像送信 or ストーリーズメンションが最新 → 対象外（受注なし）
- マイタウン奈良：あいさつのやり取り（当方最終送信）→ 対象外
- 前回ログの Camaro&N-ONE・犬の訪問整体健犬@bridge・DogRun Cafe Pic は今回の直近ウィンドウに非表示（旧ログ扱い／必要時に受信箱で要確認）
<!-- IG_DM_MANUAL:END -->
