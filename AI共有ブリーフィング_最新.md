...
### 📨 2026-07-01 07:06 Instagram DM チェック（Meta Business Suite）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-07-01 07:06 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 9件 / うち受注関連の可能性 2件

**🧾 受注関連の可能性（要対応・チェックでクローズ）:**
- [ ] send-only@iv.kingoftime.jp ｜ [KING OF TIME]2026年06月分 請求書発行のご連絡（INV02042610）
- [ ] "ラクスル" <mag@raksul.com> ｜ 【制作費0円】更新も修正も自分でできるホームページへ、ラクに乗り換え
<!-- GMAIL_INBOX:END -->

<!-- CHATWORK_INBOX:START -->
### 💬 2026-07-01 07:06 Chatwork 新着チェック（既読ルーム精査）
...
<!-- IG_DM_INBOX:START -->
### 📩 2026-07-01 07:06 Instagram DM 新着チェック（会話精査）
