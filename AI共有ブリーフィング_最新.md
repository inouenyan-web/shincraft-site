...
### 📨 2026-06-30 15:42 Instagram DM チェック（Meta Business Suite）
...
<!-- GMAIL_INBOX:START -->
### 📧 2026-06-30 15:42 Gmail 新着チェック（自動 / shincraft2023）

直近24h未読 8件 / うち受注関連の可能性 2件
...
### 💬 2026-06-30 15:42 Chatwork 新着チェック（既読ルーム精査）
...
<!-- IG_DM_INBOX:START -->
### 📩 2026-06-30 15:42 Instagram DM 新着チェック（会話精査）
...
<!-- IG_DM_MANUAL:START -->
### 📩 2026-06-30 12:15 JST Instagram DM 受注・要対応（Cowork目視 / Meta Business Suiteより）

- [ ] 🔴 [DM] y.s：PayPay支払いの相談「PayPayが助かります。でも、いま残高ないので明日チャージして朝支払いでも大丈夫ですか？」→ 未返信・要返信（当日朝の後払い可否を回答）
- [ ] 🟡 [DM] やっちゃん：本日7:01「iQOSありがとうございました。インスタあげてもらっても大丈夫ですよ」＋領収書PDF受領・納品/支払い完了 → 掲載許可取得済み（投稿OK）、一言お礼返信を推奨
- [ ] 🟡 [DM] ディープさん（タイニープードル）：当方からオリジナルIQOS提案を送信済み（最終メッセージは当方アウトバウンド）→ 相手の返信待ち（フォロー）
- [ ] 🟡 [DM] Boost Works（業務改善・DX支援）：当方から提案/添付を送信済み（アウトバウンド）→ 返信待ち

（お礼のみ/いいね/ストーリーズメンション/雑談はタスク化対象外：Takaoki Moriguchi、Life Design Lab 朔矢、個性アドバイザー/朝田奈美、ほっぷ@VANLIFE）
<!-- IG_DM_MANUAL:END -->
