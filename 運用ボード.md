...
<!-- IG_DM_MANUAL:START -->
### 📩 2026-06-30 12:04 JST Instagram DM 受注・要対応（Cowork目視 / Meta Business Suiteより）

- [ ] 🔴 [DM] y.s：PayPay支払いの相談「いま残高ないので明日チャージして朝支払いでも大丈夫ですか？」→ 未返信・要返信（入金タイミング可否を回答）
- [ ] 🟡 [DM] やっちゃん：掲載許可を取得済み「インスタあげてもらっても大丈夫ですよ」＋iQOSお礼 → 投稿OK・一言お礼推奨（前回の許可待ちは解消）
- [ ] 🟡 [DM] ディープさん（タイニープードル）：オリジナルIQOS提案画像を当方から送信済み → 相手の返信待ち（フォロー）
- [ ] 🟡 [DM] Boost Works：オリジナルIQOS提案を当方から送信済み（アウトバウンド）→ 返信待ち

（お礼・いいね・ストーリーズメンション等はタスク化対象外）
<!-- IG_DM_MANUAL:END -->
